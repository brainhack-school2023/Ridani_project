...
A summary of the susceptibility values is as follows [6]:
...
- χ-separation performed better when the χ-model was simpler, which could be one of the algorithm's limitations.
